...
/**
 * Log helper used by the server to format console output
 */
...
export function serveStatic(app: Express) {
  // path.resolve to the dist/public folder created during build
  ...
  // Serve static assets with a cache-control header
